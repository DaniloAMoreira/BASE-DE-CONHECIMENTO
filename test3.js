                ...
                try {
                    ...
                    if (window.editingCmdId) {
                        resCmd = await fetch(`${SUPABASE_URL}/rest/v1/comandos?id=eq.${window.editingCmdId}`, {
                            method: 'PATCH',
                            headers,
                            body: JSON.stringify({ categoria_id: window.editingCmdCategoryId || 1, name: title, command: commandJsonStr })
                        });
                        window.editingCmdId = null;
                    } else {
                        resCmd = await fetch(`${SUPABASE_URL}/rest/v1/comandos`, {
                            method: 'POST',
                            headers,
                            body: JSON.stringify({ categoria_id: 1, name: title, command: commandJsonStr })
                        });
                    }
